...
public class ModeloTablaProductos extends AbstractTableModel {
    ...
    private final String[] columnas= {"Codigo", "Nombre","Costo", "Precio Venta", "Stock","Codigo Barra"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
       ...
       switch (columnIndex){
           ...
           case 2: return p.getPrecioCosto();
           case 3: return p.getPrecioVenta();
           case 4: return p.getStock();
           case 5: return p.getCodigoBarra();
           default: return null;
       }
    }
    @Override
    ...
    public Class<?> getColumnClass(int columnIndex) {
        switch (columnIndex) {
            ...
            case 2: return Double.class;  // Precio Costo
